...
public class MultiInstancePlotter extends ApplicationFrame {
    public MultiInstancePlotter(String applicationTitle, String chartTitle, Map<Pair<Integer, Integer>, Double> data) {
    ...
    public static void main(String[] args) {
        ...
        MultiInstancePlotter chart = new MultiInstancePlotter("TEST", "TESTChart", data);
